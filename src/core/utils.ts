 ...
 * @param {string} _keyForLogging - Optional key name for more descriptive error messages
 ...
 * }
 */
export const validateTTL = (ttl: number | undefined, _keyForLogging?: string): void => {
